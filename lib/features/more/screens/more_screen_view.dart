...
import 'package:flutter_sixvalley_ecommerce/features/join_us/screens/join_us_screen.dart';
              ...
              Padding(padding:  const EdgeInsets.all(Dimensions.paddingSizeDefault),
                  child: Container(padding:  const EdgeInsets.all(Dimensions.paddingSizeSmall),
                      ...
                      child: Column(children: [
                        ...
                        MenuButtonWidget(image: Images.city, title: getTranslated('join_us', context),
                            navigateTo: const JoinUsScreen()),
